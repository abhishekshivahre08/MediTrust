...
const flowSteps = [
  {
    title: "Scan",
    icon: Camera,
    caption: "Capture the secure QR seal from any MediTrust-enabled medicine strip or carton.",
  },
  {
    title: "Validate",
    icon: ActivitySquare,
    caption: "We reconcile manufacturing, logistics, and regulator attestations in under 400ms.",
  },
  {
    title: "Locate",
    icon: Network,
  ...
  },
  {
    title: "Treat",
    icon: HeartPulse,
    caption: "Clinicians and caregivers act with confidence knowing authenticity is assured.",
  },
];
      ...
      <section className="relative overflow-hidden rounded-[3.5rem] border border-white/40 bg-white/90 px-6 py-16 shadow-[0_55px_120px_-60px_rgba(12,74,110,0.55)] backdrop-blur-2xl lg:px-18 lg:py-20 dark:border-white/10 dark:bg-slate-900/75">
        ...
        <div className="relative z-10 grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base text-muted-foreground sm:text-lg">
                Counterfeit medicines endanger millions. MediTrust combines blockchain provenance, live supply intelligence,
                and pharmacy-grade telemetry so you can validate authenticity before the first dose is dispensed.
              </p>
            </div>
            ...
            <dl className="mt-8 grid gap-4 sm:grid-cols-3">
              {impactStats.map((stat) => (
                ...
                >
                  <dt className="text-4xl font-bold text-primary sm:text-5xl">{stat.value}</dt>
          ...
          <div className="relative">
            <div className="absolute inset-0 -rotate-6 rounded-[3rem] bg-gradient-to-br from-primary/40 via-primary/10 to-accent/40 blur-3xl" aria-hidden />
            <div className="relative space-y-5 rounded-[2.75rem] border border-white/40 bg-white/85 p-6 shadow-[0_50px_90px_-45px_rgba(12,74,110,0.55)] dark:border-white/10 dark:bg-slate-900/70">
              <div className="glass-panel rounded-[2.5rem] border border-primary/15 bg-gradient-to-tr from-white via-white to-primary/10 p-6 text-left shadow-inner dark:from-slate-900 dark:via-slate-900 dark:to-primary/15">
                <p className="text-sm font-semibold uppercase tracking-[0.4em] text-primary">Real-time signal</p>
                <p className="mt-4 text-lg font-semibold text-foreground">
                  407 verified doses dispensed in the last 60 minutes across Mumbai, Pune, and Ahmedabad.
                </p>
                <p className="mt-3 text-sm text-muted-foreground">
                  MediTrust auto-flags anomalies so field agents can intervene before counterfeit stock circulates.
                </p>
              </div>
      ...
      <section className="grid gap-8 rounded-[3.5rem] border border-white/40 bg-white/90 px-6 py-14 shadow-card backdrop-blur-2xl lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:px-18 dark:border-white/10 dark:bg-slate-900/75">
        <div className="space-y-5">
          ...
          <h2 className="text-3xl font-semibold text-foreground sm:text-4xl">
            Authenticity verification stitched into every moment of the care journey.
          </h2>
          <p className="text-base text-muted-foreground">
            MediTrust blends on-device cryptography, regulatory attestations, and pharmacy inventory bridges. The result is
            a seamless experience that earns trust from clinicians, caregivers, and policy makers alike.
          </p>
        </div>
        <ol className="relative grid gap-6">
          <div className="absolute left-5 top-6 bottom-6 w-px bg-gradient-to-b from-primary/40 via-primary/10 to-accent/40" aria-hidden />
          {flowSteps.map((step, index) => (
            <li key={step.title} className="glass-panel relative flex gap-5 rounded-3xl px-6 py-5 shadow-sm">
              <span className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-card">
                ...
                <span className="absolute -left-10 font-semibold text-muted-foreground">{String(index + 1).padStart(2, "0")}</span>
              </span>
      ...
      <section className="rounded-[3.5rem] border border-white/40 bg-white/90 px-6 py-14 shadow-card backdrop-blur-2xl lg:px-18 dark:border-white/10 dark:bg-slate-900/75">
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl font-semibold text-foreground sm:text-4xl">Built with India’s medicine safety mission at heart.</h2>
            <p className="text-base text-muted-foreground">
              Counterfeit seizures grew 26% last year, while rural access to genuine stock dropped sharply. MediTrust equips
              pharmacists, regulators, and caregivers with contextual insights so every patient receives authentic treatment.
            </p>
            <div className="glass-panel rounded-[2.5rem] border border-primary/10 bg-gradient-to-br from-primary/10 via-transparent to-accent/15 px-6 py-5 text-sm text-foreground">
              <p className="text-base font-semibold text-primary">
                “We restored confidence across our 180 outlets in less than two weeks. Patients now ask for their MediTrust
        ...
        <div className="relative z-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="text-base text-primary-foreground/85">
              Whether you are a pharmacy chain, hospital group, or regulator, MediTrust helps you restore faith in every
              prescription.
            </p>
            <div className="flex flex-wrap items-center gap-4">
              <Link
