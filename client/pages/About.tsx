    ...
    <div className="space-y-10 pb-12">
      <header className="rounded-[3rem] border border-white/40 bg-white/90 px-6 py-12 shadow-card backdrop-blur-xl lg:px-16 dark:border-white/10 dark:bg-slate-900/80">
        ...
        <p className="mt-4 max-w-3xl text-base text-muted-foreground">
          MediTrust was conceived during a health-tech hackathon to restore
          trust in medicine authenticity across India. Share your team story,
          mission, and roadmap here to spotlight the people building this
          movement.
        </p>
      </header>
      ...
      <section className="rounded-[3rem] border border-dashed border-primary/30 bg-white/60 px-6 py-10 shadow-card backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/70">
        ...
        <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
          This is a placeholder canvas. Prompt Fusion when you're ready to add
          team bios, hackathon highlights, or press coverage so we can craft a
          cohesive story section.
        </p>
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          {["Our mission", "Team", "Hackathon Journey", "Partners"].map(
            (item) => (
              <div
                key={item}
